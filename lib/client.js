(function() {
  ...
  Client = (function() {
    ...
    function Client() {
      ...
      this.redisConfigs = {};
      this.isLogger = false;
      this.slaveHandleFunctions = 'get strlen exists getbit getrange '.split(' ');
    }
    ...
    */
    ...
    Client.prototype._client = function(name, funcName) {
      var clients, connectTotal, redisClients, redisConfig, redisServerTotal, self;
      self = this;
      ...
      if (!redisClients) {
        ...
        return clients[name] = redisClients;
      } else {
